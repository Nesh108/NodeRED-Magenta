...
server_thread = threading.Thread(target=start_server, name="TCP Server", daemon=True, args=(client_message, 65432))
server_thread.start()
print('started')
comm_thread = threading.Thread(target=start_comm_server, name="Comm Server", daemon=True, args=(client_message, 7979))
comm_thread.start()
manage()
